...
- 时间: 2026-04-25T00:05:20.101Z
- HOOK_URL: http://127.0.0.1:4822/hook
- N (起点): 1, 长尾自动扩展: 30
- sessions: [{"windowId":420604605}]
...
|---|---|---|---|---|---|---|---|---|
| S1 | baseline | 1 | 100% | 7432ms | 7432ms | 0 | 0 |  |
...
- 理论最小 tool 调用: 3
- N: 1, 成功: 1, 成功率: 100.0%
- **RTT**: p50=**7432ms**, p95=**7432ms**, avg=7432ms, min=7432ms, max=7432ms
