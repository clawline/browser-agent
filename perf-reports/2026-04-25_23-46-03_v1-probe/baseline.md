...
|---|---|---|---|---|---|---|---|---|---|
| W1 | extraction | 1 | 100% | 1/1 (100%) | 1 | 14263ms | 14263ms | 2 | 0 |

## 分类汇总

| 分类 | 场景数 | 总运行数 | 校验通过 | 平均 score | 平均 p50 RTT | 平均 tools |
|---|---|---|---|---|---|---|
| extraction | 1 | 1 | 1/1 (100%) | 1 | 14263ms | 2 |
...
- **RTT**: p50=**14263ms**, p95=**14263ms**, avg=14263ms, min=14263ms, max=14263ms
